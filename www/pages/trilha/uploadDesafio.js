angular.module("eurecaJovem").controller("uploadDesafio", function ($route, $scope, $routeParams, $location, $mdToast, $rootScope, eurecaJovemStorageAPI, FileUploader, $http, $sessionStorage) {

    var encodedString = eurecaJovemStorageAPI.pegarChave();

    var uploader = $scope.uploader = new FileUploader({
        //url: 'http://localhost:8080/eureca/ws/arquivos/enviarDesafio',
        url: "http://anga-pepsico.jelasticlw.com.br/ws/arquivos/enviarDesafio",
    ...
    $scope.passarParametrosEnviar = function (desafio) {
        //console.log("passa parametros: ", desafio);
    ...
    uploader.onBeforeUploadItem = function (item) {
        ...
        item.formData.push({ desafio: $scope.desafio });
