...
angular.module("eurecaJovem", ["ngMessages", "ngRoute", "ngMaterial", "ngMaterialDatePicker", "angular-timeline", "youtube-embed", "ngStorage"]).config(function($mdThemingProvider, $mdIconProvider) {
