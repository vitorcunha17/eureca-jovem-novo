    ...
    <md-card-content class="md-padding">
      ...
      <div layout-gt-md="row" layout="column" layout-align-gt-md="center center">
        <md-input-container flex-gt-md="30">
          ...
          <input mdc-datetime-picker date="false" time="true" type="text" id="time2" short-time="false"
                 placeholder="Time" minutes="true"
                 min-date="minDate"
                 format="HH:mm"
                 ng-model="time">
      ...
      <div layout-gt-md="row" layout="column" layout-align-gt-md="center center">
        <md-input-container flex-gt-md="30">
          ...
          <input mdc-datetime-picker date="true" time="false" type="text" id="datelang"
                 placeholder="Date" show-todays-date minutes="true" lang="{{selectedLang}}"
                 min-date="date" format="MMM D, YYYY"
                 class="md-input" cancel-text="{{'CANCEL'|translate}}" today-text="{{'TODAY'|translate}}"
                 ng-model="dateLang">
        </md-input-container>
        <div flex-gt-md="grow" ex-source-code target="input"></div>
      </div>
